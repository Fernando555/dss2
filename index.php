...
?>
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div style="height: 250px; background-image: url(assets/images/gambar3.jpg); background-repeat: no-repeat; background-position:right; left:-180px ;position:relative;">
